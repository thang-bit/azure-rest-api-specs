...
public final class DiscoTemplatePageResponse {
    ...
    private List<DiscoTemplateResponse> value;
    ...
    private DiscoTemplatePageResponse(
            @JsonProperty(value = "value", required = true) List<DiscoTemplateResponse> value) {
        this.value = value;
    }
     ...
     */
    public List<DiscoTemplateResponse> getValue() {
        return this.value;
    }
}
