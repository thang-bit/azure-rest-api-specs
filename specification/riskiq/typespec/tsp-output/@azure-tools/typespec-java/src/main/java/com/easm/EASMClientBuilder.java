...
public final class EASMClientBuilder implements HttpTrait<EASMClientBuilder>, ConfigurationTrait<EASMClientBuilder> {
    ...
    @Generated private static final Map<String, String> PROPERTIES = CoreUtils.getProperties("easm.properties");
     ...
     */
    @Generated
    public EASMClientBuilder region(String region) {
        this.region = region;
        return this;
    }
    ...
    private EASMClientImpl buildInnerClient() {
        ...
        String localRegion = (region != null) ? region : "eastus";
    ...
    public EASMClient buildClient() {
        return new EASMClient(new EASMAsyncClient(buildInnerClient()));
    }
}
