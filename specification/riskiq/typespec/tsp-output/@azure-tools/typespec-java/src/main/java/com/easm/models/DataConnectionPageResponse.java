...
public final class DataConnectionPageResponse {
    ...
    private List<DataConnectionResponse> value;
    ...
    private DataConnectionPageResponse(
            @JsonProperty(value = "value", required = true) List<DataConnectionResponse> value) {
        this.value = value;
    }
     ...
     */
    public List<DataConnectionResponse> getValue() {
        return this.value;
    }
}
