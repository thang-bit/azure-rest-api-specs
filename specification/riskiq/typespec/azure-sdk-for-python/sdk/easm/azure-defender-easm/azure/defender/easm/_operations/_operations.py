...
from .._vendor import EASMClientMixinABC, _format_url_section
...
def build_easm_assets__list_request(
    subscription_id: str,
    ...
    **kwargs: Any
    ...
    _params["api-version"] = _SERIALIZER.query("apiversion", apiversion, "str")
...
def build_easm_assets__update_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_assets__get_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    asset_id: str,
...
def build_easm_data_connections__list_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_data_connections__validate_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/dataConnections:validate"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
...
def build_easm_data_connections__get_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
...
def build_easm_data_connections__put_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    data_connection_name: str,
...
def build_easm_data_connections__delete_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    data_connection_name: str,
...
def build_easm_discovery_groups__list_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_discovery_groups__validate_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    group_name: str,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/discoGroups:validate/{groupName}"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
...
def build_easm_discovery_groups__get_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    group_name: str,
...
def build_easm_discovery_groups__put_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    group_name: str,
...
def build_easm_discovery_groups__run_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    group_name: str,
...
def build_easm_discovery_groups__list_runs_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    group_name: str,
...
def build_easm_discovery_templates__list_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_discovery_templates__get_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    template_id: str,
...
def build_easm_reports__billable_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_easm_reports__snapshot_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_easm_reports__snapshot__export_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/workspaces/{workspaceName}/reports/assets:getSnapshotExport"  # pylint: disable=line-too-long
    path_format_arguments = {
        "subscriptionId": _SERIALIZER.url("subscription_id", subscription_id, "str"),
        "resourceGroupName": _SERIALIZER.url("resource_group_name", resource_group_name, "str"),
        "workspaceName": _SERIALIZER.url("workspace_name", workspace_name, "str"),
...
def build_easm_reports__summary_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_easm_saved_filters__list_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_saved_filters__get_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    filter_name: str,
...
def build_easm_saved_filters__put_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    filter_name: str,
...
def build_easm_saved_filters__delete_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    filter_name: str,
...
def build_easm_tasks__list_request(
    subscription_id: str,
    resource_group_name: str,
    workspace_name: str,
    *,
...
def build_easm_tasks__get_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, task_id: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
def build_easm_tasks__cancel_request(
    subscription_id: str, resource_group_name: str, workspace_name: str, task_id: str, *, apiversion: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class EASMClientOperationsMixin(EASMClientMixinABC):  # pylint: disable=too-many-public-methods
    ...
    @overload
    def data_connections__validate(
        self,
        subscription_id: str,
        resource_group_name: str,
        workspace_name: str,
    ...
    @distributed_trace
    def data_connections__delete(  # pylint: disable=inconsistent-return-statements
        self,
        subscription_id: str,
        resource_group_name: str,
        workspace_name: str,
    ...
    @overload
    def discovery_groups__validate(
        self,
        subscription_id: str,
        resource_group_name: str,
        workspace_name: str,
    ...
    @distributed_trace
    def discovery_groups__run(  # pylint: disable=inconsistent-return-statements
        self, subscription_id: str, resource_group_name: str, workspace_name: str, group_name: str, **kwargs: Any
    ) -> None:
    ...
    @distributed_trace
    def discovery_groups__list_runs(
        self,
        subscription_id: str,
        resource_group_name: str,
        workspace_name: str,
    ...
    @distributed_trace
    def saved_filters__delete(  # pylint: disable=inconsistent-return-statements
        self, subscription_id: str, resource_group_name: str, workspace_name: str, filter_name: str, **kwargs: Any
    ) -> None:
