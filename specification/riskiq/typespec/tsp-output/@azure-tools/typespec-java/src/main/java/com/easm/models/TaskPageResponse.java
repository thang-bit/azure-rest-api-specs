...
public final class TaskPageResponse {
    ...
    private List<TaskResponse> value;
     ...
     */
    @JsonCreator
    private TaskPageResponse(@JsonProperty(value = "value", required = true) List<TaskResponse> value) {
        this.value = value;
    }
     ...
     */
    public List<TaskResponse> getValue() {
        return this.value;
    }
}
